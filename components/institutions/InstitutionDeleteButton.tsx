...
import { deleteInstitution } from '@/lib/institutions/actions';
...
export function InstitutionDeleteButton({ id, name }: InstitutionDeleteButtonProps) {
